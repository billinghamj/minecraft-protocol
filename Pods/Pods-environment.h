...
// DNSKit
#define COCOAPODS_POD_AVAILABLE_DNSKit
#define COCOAPODS_VERSION_MAJOR_DNSKit 0
#define COCOAPODS_VERSION_MINOR_DNSKit 0
#define COCOAPODS_VERSION_PATCH_DNSKit 1
