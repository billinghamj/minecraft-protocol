...
#ifndef __MinecraftProtocol__Packets__StatusCB__PingPacket__
#define __MinecraftProtocol__Packets__StatusCB__PingPacket__
...
#endif /* defined(__MinecraftProtocol__Packets__StatusCB__PingPacket__) */
